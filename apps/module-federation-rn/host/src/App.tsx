...
function App() {
    ...
    const reloadRuntime = () => DevSettings.reload()

    return (
        <ScrollView contentContainerStyle={styles.page}>
            <View style={styles.header}>
                <Text style={styles.eyebrow}>STOCK REACT NATIVE / METRO</Text>
                <Text style={styles.title}>Federated Uniwind styles</Text>
                <Text style={styles.intro}>
                    The host owns global CSS. Each remote contributes an explicitly prefixed, owner-keyed native delta. Load both orders; every signal
                    must keep its declared color.
                </Text>
            </View>
            ...
            <View style={styles.explanation}>
                ...
                <Text style={styles.explanationText}>
                    Remote source uses explicit rma: and rmb: classes, including prefixed theme variables. Native registrations merge under remoteA
                    and remoteB instead of replacing the host. All nine bars remain stable in either load order.
                </Text>
            </View>
        </ScrollView>
    )
